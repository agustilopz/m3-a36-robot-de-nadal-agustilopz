...
/*-------------------------------------------------------------------*/
const val BOLD: String = "\u001b[1m"  // BOLD NO COLOR
const val BOLD_HIGH_INTENSITY: String = "\u001b[1m"  // BOLD + HIGH INTENSITY
const val BOLD_UNDERLINED: String = "\u001b[1;4m"  // BOLD + UNDERLINED
